...
export const Calendar: React.FC<CalendarProps> = ({
  ...
  // Calcular feriados móveis se habilitado
  ...
  // Memoizar o status de horário de funcionamento
  ...
  const getDayClassName = (day: CalendarDay): string => {
    ...
    if (day.appointments.length >= maxAppointmentsPerDay) {
      classes.push('calendar-day-full');
    }
